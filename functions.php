...
function wpangular_init() {
	wp_enqueue_style( 'montserrat', "//fonts.googleapis.com/css?family=Montserrat:300,300i,500,500i,700,700i", null, null);
	wp_enqueue_style( 'wpangular', get_stylesheet_directory_uri() . '/css/default.css', null, null);
